        ...
        .say-main-container.uk-flex.uk-flex-middle(class="uk-child-width-1-2@m uk-grid", uk-grid)   
            div
                div.uk-section.uk-container(class="uk-width-xlarge@m  uk-margin-auto") 
                    ...
                    form.uk-margin-top(action="" method="method")
                        .uk-margin
                            label.uk-form-label Nombre
                            .uk-form-controls
                                input.uk-input.uk-form-large(type="text", placeholder="Juan Acosta")
                        .uk-margin
                            label.uk-form-label Email
                            .uk-form-controls
                                input.uk-input.uk-form-large(type="email", placeholder="usuario@email.com")
                        .uk-margin
                            label.uk-form-label Información
                            .uk-form-controls
                                input.uk-input.uk-form-large(type="text", placeholder="Tu Información")
                        .uk-margin
                            label.uk-form-label Mensaje
                            .uk-form-controls
                                textarea.uk-textarea.uk-form-large(rows="4", type="textarea", placeholder="...")
                        .uk-margin.uk-text-right
                            button.form-send-button.uk-button Enviar Mensaje
